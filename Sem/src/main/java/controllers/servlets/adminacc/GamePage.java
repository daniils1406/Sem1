...
public class GamePage extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        Game game= gameService.findById((Long) req.getSession().getAttribute("ClickGame"));
        ...
        RequestDispatcher requestDispatcher=req.getRequestDispatcher("WEB-INF/views/gameAdmin.jsp");
        requestDispatcher.forward(req,resp);
    }

    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        gameService.deleteImage(req.getParameter("nameOfImage"),req.getParameter("nameOfGame"));
        resp.sendRedirect("/gameAdmin");
    }
}
